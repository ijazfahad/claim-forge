...
exports.SSPAgent = void 0;
const base_agent_1 = require("./base-agent");
class SSPAgent extends base_agent_1.BaseAgent {
    constructor() {
        super();
        this.agent = null;
    }
...
`;
    ...
    async predictSpecialty(payload) {
        if (!this.agent) {
...
exports.SSPAgent = SSPAgent;
//# sourceMappingURL=ssp-agent.js.map