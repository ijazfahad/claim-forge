...
exports.TEST_CASES_BY_CATEGORY = exports.TEST_CASES = void 0;
exports.getTestCaseById = getTestCaseById;
exports.getTestCasesByTag = getTestCasesByTag;
exports.TEST_CASES = [
    {
        id: 'sanity_001',
...
exports.TEST_CASES_BY_CATEGORY = {
    sanity_check: exports.TEST_CASES.filter(tc => tc.tags.includes('sanity_check')),
    planner: exports.TEST_CASES.filter(tc => tc.tags.includes('planner')),
    research: exports.TEST_CASES.filter(tc => tc.tags.includes('research')),
    retry: exports.TEST_CASES.filter(tc => tc.tags.includes('retry')),
    evaluate: exports.TEST_CASES.filter(tc => tc.tags.includes('evaluate')),
    edge_case: exports.TEST_CASES.filter(tc => tc.category === 'edge_case'),
    good: exports.TEST_CASES.filter(tc => tc.category === 'good'),
    bad: exports.TEST_CASES.filter(tc => tc.category === 'bad')
};
function getTestCaseById(id) {
    return exports.TEST_CASES.find(tc => tc.id === id);
}
function getTestCasesByTag(tag) {
    return exports.TEST_CASES.filter(tc => tc.tags.includes(tag));
}
